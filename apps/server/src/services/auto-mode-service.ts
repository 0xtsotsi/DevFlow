...
export class AutoModeService {
  ...
  // HYBRID-M2: Beads integration for epic-aware execution
  ...
  // Pipeline service for workflow automation
  ...
  constructor(
    ...
    if (beadsService) {
      ...
      this.beadsOrchestrator = new BeadsOrchestrator(events, beadsService);
      this.useBeadsOrchestration = true;
    }
  }
  ...
  async executeFeature(
    ...
    try {
      ...
      if (this.pipelineService) {
        const pipelineConfig = await this.pipelineService.getPipelineConfig(projectPath);
